...
LONG WINAPI ExceptionHandler(EXCEPTION_POINTERS* ep)
{
    ...
    std::string msg = "Could not start the .NET Desktop Runtime version " + version + ".\n Please make sure you have both the x86 and x64 editions installed.  You can also try\n\nusing the 7H exe installer or visit https://dotnet.microsoft.com for more information.";
