...
begin
  try
    IsProductInstalled := Dependency_IsNetCoreInstalled('Microsoft.WindowsDesktop.App 8.0.5')
  except
  ...
  if not IsProductInstalled then begin
    Dependency_Add('dotnet80desktop' + Dependency_ArchSuffix + '.exe',
      ...
      Dependency_String('https://dotnetcli.azureedge.net/dotnet/WindowsDesktop/8.0.5/windowsdesktop-runtime-8.0.5-win-x86.exe', 'https://dotnetcli.azureedge.net/dotnet/WindowsDesktop/8.0.5/windowsdesktop-runtime-8.0.5-win-x64.exe'),
      '', False, False);
  end;
end;
