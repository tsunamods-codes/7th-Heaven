...
begin
  ...
  if not IsMsiProductInstalled(Dependency_String('{9C19C103-7DB1-44D1-A039-2C076A633A38}', '{19AFE054-CA83-45D5-A9DB-4108EF4BD391}'), PackVersionComponents(14, 38, 33135, 0)) then begin
