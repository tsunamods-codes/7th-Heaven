...
begin
  ...
  if not Dependency_IsNetCoreInstalled('Microsoft.NETCore.App 7.0.14') then begin
    Dependency_Add('dotnet70' + Dependency_ArchSuffix + '.exe',
      '/lcid ' + IntToStr(GetUILanguage) + ' /passive /norestart',
      '.NET Runtime 7.0.14' + Dependency_ArchTitle,
      Dependency_String('https://dotnetcli.azureedge.net/dotnet/Runtime/7.0.14/dotnet-runtime-7.0.14-win-x86.exe', 'https://dotnetcli.azureedge.net/dotnet/Runtime/7.0.14/dotnet-runtime-7.0.14-win-x64.exe'),
      '', False, False);
  end;
end;
...
begin
  // https://dotnet.microsoft.com/download/dotnet/7.0
  if not Dependency_IsNetCoreInstalled('Microsoft.AspNetCore.App 7.0.14') then begin
    Dependency_Add('dotnet70asp' + Dependency_ArchSuffix + '.exe',
      '/lcid ' + IntToStr(GetUILanguage) + ' /passive /norestart',
      'ASP.NET Core Runtime 7.0.14' + Dependency_ArchTitle,
      Dependency_String('https://dotnetcli.azureedge.net/dotnet/aspnetcore/Runtime/7.0.14/aspnetcore-runtime-7.0.14-win-x86.exe', 'https://dotnetcli.azureedge.net/dotnet/aspnetcore/Runtime/7.0.14/aspnetcore-runtime-7.0.14-win-x64.exe'),
      '', False, False);
  end;
end;
...
begin
  // https://dotnet.microsoft.com/download/dotnet/7.0
  if not Dependency_IsNetCoreInstalled('Microsoft.WindowsDesktop.App 7.0.14') then begin
    Dependency_Add('dotnet70desktop' + Dependency_ArchSuffix + '.exe',
      '/lcid ' + IntToStr(GetUILanguage) + ' /passive /norestart',
      '.NET Desktop Runtime 7.0.14' + Dependency_ArchTitle,
      Dependency_String('https://dotnetcli.azureedge.net/dotnet/WindowsDesktop/7.0.14/windowsdesktop-runtime-7.0.14-win-x86.exe', 'https://dotnetcli.azureedge.net/dotnet/WindowsDesktop/7.0.14/windowsdesktop-runtime-7.0.14-win-x64.exe'),
      '', False, False);
  end;
end;
...
begin
  ...
  if not Dependency_IsNetCoreInstalled('Microsoft.NETCore.App 8.0.1') then begin
    Dependency_Add('dotnet80' + Dependency_ArchSuffix + '.exe',
      ...
      Dependency_String('https://dotnetcli.azureedge.net/dotnet/Runtime/8.0.1/dotnet-runtime-8.0.1-win-x86.exe', 'https://dotnetcli.azureedge.net/dotnet/Runtime/8.0.1/dotnet-runtime-8.0.1-win-x64.exe'),
      '', False, False);
  end;
end;
...
begin
  ...
  if not Dependency_IsNetCoreInstalled('Microsoft.AspNetCore.App 8.0.1') then begin
    Dependency_Add('dotnet80asp' + Dependency_ArchSuffix + '.exe',
      ...
      Dependency_String('https://dotnetcli.azureedge.net/dotnet/aspnetcore/Runtime/8.0.1/aspnetcore-runtime-8.0.1-win-x86.exe', 'https://dotnetcli.azureedge.net/dotnet/aspnetcore/Runtime/8.0.1/aspnetcore-runtime-8.0.1-win-x64.exe'),
      '', False, False);
  end;
end;
...
begin
  ...
  if not Dependency_IsNetCoreInstalled('Microsoft.WindowsDesktop.App 8.0.1') then begin
    Dependency_Add('dotnet80desktop' + Dependency_ArchSuffix + '.exe',
      ...
      Dependency_String('https://dotnetcli.azureedge.net/dotnet/WindowsDesktop/8.0.1/windowsdesktop-runtime-8.0.1-win-x86.exe', 'https://dotnetcli.azureedge.net/dotnet/WindowsDesktop/8.0.1/windowsdesktop-runtime-8.0.1-win-x64.exe'),
      '', False, False);
  end;
end;
